...
test('CSS component - gutters', (t) => {
  ...
  const expected = -8;
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?selectedKind=CSS%20component&selectedStory=gutters')
    .wait('.z-grid')
...
test('CSS component - reverse grid', (t) => {
  ...
  const expected = true;
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?selectedKind=CSS%20component&selectedStory=reverse%20grid')
    .wait('.z-grid')
    .evaluate(() => {
...
test('CSS component - center grid', (t) => {
  ...
  return Nightmare()
    .viewport(640, 480)
    .goto('http://localhost:6006/iframe.html?selectedKind=CSS%20component&selectedStory=center%20grid')
    .wait('.z-grid')
    .evaluate(() => {
...
test('CSS component - fit', (t) => {
  ...
  return Nightmare()
    .viewport(640, 480)
    .goto('http://localhost:6006/iframe.html?selectedKind=CSS%20component&selectedStory=fit')
    .wait('.z-grid')
    .evaluate(() => {
      const grid = document.querySelector('.z-grid');
      const gridWidth = parseInt(getComputedStyle(grid).width, 10);
...
test('CSS component - important column example', (t) => {
  ...
  return Nightmare()
    .viewport(640, 480)
    .goto('http://localhost:6006/iframe.html?selectedKind=CSS%20component&selectedStory=important%20column%20example')
    .wait('.z-grid')
    .evaluate(() => {
...
test('CSS component - resizing example', (t) => {
  ...
  const before = Nightmare()
    .viewport(640, 768)
    .goto('http://localhost:6006/iframe.html?selectedKind=CSS%20component&selectedStory=resizing%20example')
    .wait('.z-grid')
    .evaluate(() => {
      const grid = document.querySelector('.z-grid');
      const gridX = grid.getBoundingClientRect().left;
