...
test('CSS component - invisible column', (t) => {
  ...
  return Nightmare()
    .viewport(640, 480)
    .goto('http://localhost:6006/iframe.html?id=stateless-functional-component--invisible-column')
    .wait('.z-grid')
    .evaluate(() => {
...
test('SFC component - invisible sm', (t) => {
  const msg = 'should not display a column on small screens';
  const expected = 0;
  return Nightmare()
    .viewport(318, 480)
    .goto('http://localhost:6006/iframe.html?id=stateless-functional-component--invisibles')
    .wait('.z-grid')
    .evaluate(() => {
...
test('SFC component - invisible md', (t) => {
...
test('SFC component - invisible lg', (t) => {
...
test('SFC component - invisible xl', (t) => {
