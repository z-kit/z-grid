module.exports = {
  ...
  gutter: (browser) => {
    browser
      .url('http://localhost:6006/iframe.html?selectedKind=Stateless%20functional%20component&selectedStory=gutters')
      .waitForElementPresent('.z-grid', 1000)
  ...
  reverse: (browser) => {
    browser
      .url('http://localhost:6006/iframe.html?selectedKind=Stateless%20functional%20component&selectedStory=reverse%20grid')
      .waitForElementPresent('.z-grid', 1000)
      .getLocation('.z-grid', (gridLocation) => {
  ...
  center: (browser) => {
    browser
      .url('http://localhost:6006/iframe.html?selectedKind=Stateless%20functional%20component&selectedStory=center%20grid')
      .waitForElementPresent('.z-grid', 1000)
      .getLocation('.z-grid', (gridLocation) => {
        const gridX = gridLocation.value.x;
        browser.getElementSize('.z-grid', (gridSize) => {
  ...
  fit: (browser) => {
    browser
      ...
      .url('http://localhost:6006/iframe.html?selectedKind=Stateless%20functional%20component&selectedStory=fit')
      .waitForElementPresent('.z-grid', 1000)
  ...
  important: (browser) => {
    browser
      .url('http://localhost:6006/iframe.html?selectedKind=Stateless%20functional%20component&selectedStory=important%20column%20example')
      .waitForElementPresent('.z-grid', 1000)
      .getLocation('.z-grid', (gridLocation) => {
        const gridX = gridLocation.value.x;
  ...
  resizing: (browser) => {
    browser
      .url('http://localhost:6006/iframe.html?selectedKind=Stateless%20functional%20component&selectedStory=resizing%20example')
      .waitForElementPresent('.z-grid', 1000)
